...
[image1]: images/Peek%202020-01-14%2023-18.gif "Trained Agent"
...
In order to solve, [DDPG algorithm](https://arxiv.org/pdf/1509.02971.pdf) is used. 
...
3. In order to install required packages, use: `pip install -r requirements.txt`
